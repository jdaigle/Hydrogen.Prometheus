...
namespace Hydrogen.Prometheus.Client.Exporters
{
    ...
    public static class TextFormat
    {
        ...
        public static async Task WriteAsync(Stream stream, IEnumerable<MetricFamilySamples> metricFamilys)
        {
            if (stream == null)
            {
            ...
            if (metricFamilys == null)
            {
                throw new System.ArgumentNullException(nameof(metricFamilys));
            }
